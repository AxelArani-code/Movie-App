...
public class PersonResponseResultsKnewnFor {
    ...
    public PersonResponseResultsKnewnFor() {

    }

    public PersonResponseResultsKnewnFor(float vote_average, Integer vote_count, Integer id, boolean video, String media_type, String title, Double popularity, String poster_patch, String original_language, String original_title, List<Integer> genre_ids, String backdrop_path, boolean adult, String overview, String release_date) {
